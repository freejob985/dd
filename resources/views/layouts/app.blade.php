                                ...
                                <nav class="navbar navbar-expand-lg navbar-light py-0">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="navbar-list-item nav-item"><a href="{{ route('magazines.index')}}" class="nav-link category02">الأصدرات السابقة</a></li>
                                            <li class="navbar-list-item nav-item"><a href="/articles_title" class="nav-link category02">  الأبواب</a></li>
                                            <li class="navbar-list-item nav-item"><a href="/authors" class="nav-link category03">المؤلفين  </a></li>
